package com.example.networkcommunication_homework;
	...
	private Listener<String> mCompleteListener = new Listener<String>() {
		...
		public void onResponse(String response) {
			...
			try {
				...
				ArrayAdapter<Photo> adapter = new ArrayAdapter<Photo>(MainActivity.this, android.R.layout.simple_list_item_1, android.R.id.text1, mDatas);
